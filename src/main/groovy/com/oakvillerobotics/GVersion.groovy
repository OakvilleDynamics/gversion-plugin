  ...
  void apply(Project project) {
    ...
    project.task('createVersionFile') {
      doLast {
        ...
        def git_author = executeGetOutput('git show --no-show-signature -s --format=%cn HEAD', "UNKNOWN")
        def git_date
        def date_format
        ...
        def host_name = executeGetOutput('hostname', "UNKNOWN")
        ...
        if (language == Language.JAVA) {
          new File(gversion_file_path, extension.className + ".java").withWriter { writer ->
            ...
            writer << "${indent}public static final String GIT_AUTHOR = \"$git_author\";\n"
            ...
            writer << "${indent}public static final String HOST_NAME = \"$host_name\";\n"
            writer << "\n"
          ...
          new File(gversion_file_path, extension.className + ".kt").withWriter { writer ->
            ...
            writer << "const val GIT_AUTHOR $typeString= \"$git_author\"\n"
            ...
            writer << "const val HOST_NAME $typeString= \"$host_name\"\n"
            writer.flush()
          }
